...
namespace CodeMonkey.Utils
{
    ...
    public class World_Bar
    {
        ...
        public World_Bar(Transform parent, Vector3 localPosition, Vector3 localScale, Color? backgroundColor,
        ...
        {
            UtilsClass.CreateWorldSprite(transform, "Outline", Assets.i.s_White, new Vector3(0, 0),
        ...
        {
            background = UtilsClass.CreateWorldSprite(transform, "Background", Assets.i.s_White, new Vector3(0, 0),
                localScale, sortingOrder, backgroundColor).transform;
        }
        ...
        private void SetupBar(Color barColor, Vector3 localScale, int sortingOrder)
        {
            ...
            Transform barIn = UtilsClass.CreateWorldSprite(bar, "BarIn", Assets.i.s_White,
                new Vector3(localScale.x / 2f, 0), localScale, sortingOrder, barColor).transform;
        }
