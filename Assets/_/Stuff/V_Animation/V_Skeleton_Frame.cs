...
namespace V_AnimationSystem
{
    public class V_Skeleton_Frame
    {
        ...
        public V_Skeleton_Frame(int _frameCount, Vector3 _pos, float size, float _rot, string _trigger, UVType _uvType,
            float scaleX, float scaleY, int sortingOrder, Vector2 pivot,
        ...
        public V_Skeleton_Frame(int _frameCount, Vector3 _pos, float _rot, string _trigger, UVType _uvType, float size,
            float scaleX, float scaleY, int sortingOrder, Vector2 pivot,
            Vector3 v00offset, Vector3 v01offset, Vector3 v10offset, Vector3 v11offset)
        {
            frameCount = _frameCount;
        ...
        public void RefreshVertices()
        {
            ...
            v00 = eulerQuaternion * new Vector3(-size * scaleX - pivot.x * widthHalf,
                -(size * uvHeightScale) * scaleY - pivot.y * heightHalf);
            v01 = eulerQuaternion * new Vector3(-size * scaleX - pivot.x * widthHalf,
                +(size * uvHeightScale) * scaleY - pivot.y * heightHalf);
            v10 = eulerQuaternion * new Vector3(+size * scaleX - pivot.x * widthHalf,
                -(size * uvHeightScale) * scaleY - pivot.y * heightHalf);
            v11 = eulerQuaternion * new Vector3(+size * scaleX - pivot.x * widthHalf,
                +(size * uvHeightScale) * scaleY - pivot.y * heightHalf);
        }
        ...
        {
            return new V_Skeleton_Frame(0, pos, rot, trigger, uvType, size, scaleX, scaleY, sortingOrder, pivot,
                v00offset, v01offset, v10offset, v11offset);
        }

        public V_Skeleton_Frame Clone()
        {
            return new V_Skeleton_Frame(frameCount, pos, rot, trigger, uvType, size, scaleX, scaleY, sortingOrder,
                pivot, v00offset, v01offset, v10offset, v11offset);
        }
        ...
        public static V_Skeleton_Frame Load(string save)
        {
            ...
            return new V_Skeleton_Frame(frameCount, pos, size, rot, trigger, uvType, scaleX, scaleY, sortingOrder,
                pivot, v00offset, v01offset, v10offset, v11offset);
        }
    }
}