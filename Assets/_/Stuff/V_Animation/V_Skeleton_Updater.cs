...
namespace V_AnimationSystem
{
    public class V_Skeleton_Updater : V_ISkeleton_Updater
    {
        ...
        public V_Skeleton_Updater(Mesh mesh, V_Skeleton_Anim[] loadAnims, float frameRateMod,
            float frameRateModModifier, V_UnitSkeleton.OnAnimTrigger onAnimTrigger,
            V_UnitSkeleton.OnAnimTrigger OnAnyAnimTrigger, int id = -1)
        {
            this.mesh = mesh;
            this.id = id;
        ...
        private void Play()
        {
            ...
            for (int i = 0; i < animsLength; i++)
            {
                ...
                V_UnitSkeleton.AddSquare(verticesIndex, verticesArr, uvsIndex, uvsArr, trianglesIndex, trianglesArr,
                    frame.pos, frame.v00 + frame.v00offset, frame.v01 + frame.v01offset, frame.v10 + frame.v10offset,
                    frame.v11 + frame.v11offset, V_UnitSkeleton.GetUV_Type(frame.uvType));
