...
namespace V_AnimationSystem
{
    ...
    public class V_UnitAnimation
    {
        ...
        public void PlayAnimIdleIfOnCompleteMatches(Vector3 dir, V_UnitSkeleton.OnAnimComplete OnAnimComplete,
        ...
        public void PlayAnim(UnitAnimType animType, float frameRateMod, V_UnitSkeleton.OnAnimComplete onAnimComplete,
            V_UnitSkeleton.OnAnimTrigger onAnimTrigger, V_UnitSkeleton.OnAnimInterrupted onAnimInterrupted)
        {
        ...
        public void PlayAnim(UnitAnimType animType, Vector3 dir, float frameRateMod,
            V_UnitSkeleton.OnAnimComplete onAnimComplete, V_UnitSkeleton.OnAnimTrigger onAnimTrigger,
        ...
        public void PlayAnim(UnitAnim unitAnim, float frameRateMod, V_UnitSkeleton.OnAnimComplete onAnimComplete,
            V_UnitSkeleton.OnAnimTrigger onAnimTrigger, V_UnitSkeleton.OnAnimInterrupted onAnimInterrupted)
        {
            // Ignores if same animType, same angle and same frameRateMod
        ...
        public void PlayAnimForced(UnitAnimType animType, Vector3 dir, float frameRateMod,
            V_UnitSkeleton.OnAnimComplete onAnimComplete, V_UnitSkeleton.OnAnimTrigger onAnimTrigger,
            V_UnitSkeleton.OnAnimInterrupted onAnimInterrupted)
        {
            int angle = GetAngleFromVector(dir);
        ...
        public void PlayAnimForced(UnitAnimType animType, int angle, float frameRateMod,
            V_UnitSkeleton.OnAnimComplete onAnimComplete, V_UnitSkeleton.OnAnimTrigger onAnimTrigger,
            V_UnitSkeleton.OnAnimInterrupted onAnimInterrupted)
        {
        ...
        {
            PlayAnimForced(unitAnim, frameRateMod, (UnitAnim u) =>
            {
                if (onAnimComplete != null) onAnimComplete();
            }, null, null);
        }

        public void PlayAnimForced(UnitAnim unitAnim, float frameRateMod, V_UnitSkeleton.OnAnimComplete onAnimComplete,
            V_UnitSkeleton.OnAnimTrigger onAnimTrigger, V_UnitSkeleton.OnAnimInterrupted onAnimInterrupted)
        {
            // Forcefully play animation no matter what is currently playing
        ...
        public void UpdateAnim(UnitAnimType animType, float frameRateMod, V_UnitSkeleton.OnAnimComplete onAnimComplete,
            V_UnitSkeleton.OnAnimTrigger onAnimTrigger, V_UnitSkeleton.OnAnimInterrupted onAnimInterrupted)
        {
            ...
            V_UnitSkeleton.OnAnimInterrupted onAnimInterrupted)
        {
            ...
            if (animType == activeAnimType)
            {
                ...
                else
                {
                    ...
                    activeAnim = unitAnim;
                    unitSkeleton.PlayAnimContinueFrames(unitAnim, frameRateMod, onAnimComplete, onAnimTrigger,
                        onAnimInterrupted);
                }
            }
            else
