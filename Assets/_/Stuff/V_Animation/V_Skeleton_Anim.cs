...
namespace V_AnimationSystem
{
    ...
    public class V_Skeleton_Anim
    {
        ...
        {
            return bodyPart.preset == BodyPart.Pointer_1 || bodyPart.preset == BodyPart.Pointer_2 ||
        ...
        public static V_Skeleton_Anim Load(string save)
        {
            ...
            V_Skeleton_Frame[] frames =
                V_Animation.Load_Array<V_Skeleton_Frame>(content[3], V_Skeleton_Frame.Load, "#SKELETONFRAMELIST#");
