...
namespace V_AnimationSystem
{
    public class V_UnitSkeleton
    {
        ...
        public V_UnitSkeleton(float frameRateMod,
            DelConvertLocalPositionToWorldPosition ConvertLocalPositionToWorldPosition, Action<Mesh> SetMesh)
        {
            V_Animation.Init();
        ...
        public void PlayAnim(UnitAnim unitAnim, float frameRateModModifier, OnAnimComplete onAnimComplete,
            OnAnimTrigger onAnimTrigger, OnAnimInterrupted onAnimInterrupted)
        {
            ...
            // Dynamic anim
            V_Skeleton_Updater newSkeletonUpdater = new V_Skeleton_Updater(mesh, unitAnim.GetAnims(), frameRateMod,
                frameRateModModifier, onAnimTrigger, OnAnyAnimTrigger);
        ...
        public void PlayAnimContinueFrames(UnitAnim unitAnim, float frameRateModModifier, OnAnimComplete onAnimComplete,
            OnAnimTrigger onAnimTrigger, OnAnimInterrupted onAnimInterrupted)
        {
            ...
            else
            {
                ...
                skeletonUpdater = new V_Skeleton_Updater(mesh, unitAnim.GetAnims(), frameRateMod, frameRateModModifier,
                    onAnimTrigger, OnAnyAnimTrigger);
            }
        }
        ...
        public static void AddSquare(int verticesIndex, Vector3[] verticesArr, int uvsIndex, Vector2[] uvsArr,
            int trianglesIndex, int[] trianglesArr, Vector3 localPos, Vector3 v00, Vector3 v01, Vector3 v10,
            Vector3 v11, Vector2[] squareUV)
        {
            /* 01
             * 11
             * 00
        ...
        public static void AddSquare(List<Vector3> verticesList, List<Vector2> uvsList, List<int> trianglesList,
            Vector3 localPos, Vector3 v00, Vector3 v01, Vector3 v10, Vector3 v11, Vector2[] squareUV)
        {
            /* 01
             * 11
             * 00
