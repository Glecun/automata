    ...
    public static class SaveSystem
    {
        ...
        public struct FileData
        {
            ...
            public static FileData Load(byte[] byteArr)
            {
                ...
                System.Array.Copy(byteArr, fileTypeByteAmount + headerSizeByteAmount + headerBytes.Length, saveBytes, 0,
                    headerData.saveByteLength);
        ...
        public static void Save(string fullSavePath, FileData.FileType fileType, string saveString,
            out byte[] fileSaveBytes)
        {
            // Save name containing extension
