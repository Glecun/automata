...
namespace V_AnimationSystem
{
    public class UnitAnimType
    {
        ...
        public void SetAnims(UnitAnim animDown, UnitAnim animUp, UnitAnim animLeft, UnitAnim animRight,
            UnitAnim animDownLeft, UnitAnim animDownRight, UnitAnim animUpLeft, UnitAnim animUpRight)
        {
        ...
        private static void LoadFromDataFolder()
        {
            ...
            List<FileInfo> defaultFileInfoList =
                new List<FileInfo>(defaultDir.GetFiles("*." + V_Animation.fileExtention_AnimationType));
            ...
            List<FileInfo> fileInfoList =
                new List<FileInfo>(dir.GetFiles("*." + V_Animation.fileExtention_AnimationType));
        ...
        public class BaseUnitAnimTypeEnum
        {
            ...
            public static BaseUnitAnimTypeEnum IdleDown
            {
                get { return new BaseUnitAnimTypeEnum(MethodBase.GetCurrentMethod()); }
            }
            ...
            public static implicit operator UnitAnimType(BaseUnitAnimTypeEnum unitAnimTypeEnum)
            {
                return UnitAnimType.GetUnitAnimType(unitAnimTypeEnum.str);
            }
        }
        ...
        private class UnitAnimTypeEnum
        {
            static UnitAnimTypeEnum()
            {
                FieldInfo[] fieldInfoArr =
                    typeof(UnitAnimTypeEnum).GetFields(BindingFlags.Static | BindingFlags.Public);
