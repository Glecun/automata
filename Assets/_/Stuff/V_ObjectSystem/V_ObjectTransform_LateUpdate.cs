...
namespace V_ObjectSystem
{
    ...
    public class V_ObjectTransform_LateUpdate : V_IObjectTransform, V_IDestroySelf
    {
        ...
        public V_ObjectTransform_LateUpdate(Transform transform, Func<Vector3> GetPositionFunc,
            V_Main.DelRegisterOnLateUpdate RegisterOnLateUpdate, V_Main.DelRegisterOnLateUpdate DeregisterOnLateUpdate)
        {
