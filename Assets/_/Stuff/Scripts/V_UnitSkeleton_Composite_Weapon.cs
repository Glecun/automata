...
public class V_UnitSkeleton_Composite_Weapon : V_IActiveInactive
{
    ...
    public V_UnitSkeleton_Composite_Weapon(V_Object parentObject, V_UnitSkeleton unitSkeleton,
        UnitAnim animAimWeaponRight, UnitAnim animAimWeaponRightInvertV, UnitAnim animShootWeaponRight,
        UnitAnim animShootWeaponRightInvertV)
    {
