...
public static class Sound_Manager
{
    ...
    public static AudioSource PlaySound(Sound sound, Vector3 pos = default(Vector3), object obj = null)
    {
        ...
        switch (sound)
        {
            ...
            case Sound.Sword:
                sounds = new[]
                {
                    Sound.Sword, Sound.Sword_2, Sound.Sword_3, Sound.Sword_4, Sound.Sword_5, Sound.Sword_6,
                    Sound.Sword_7
                };
                return PlayClip(dictionary[sounds[Random.Range(0, sounds.Length)]]);
            //return PlayClipAtPoint(dictionary[sounds[Random.Range(0, sounds.Length)]], pos, 100);
            ...
            case Sound.Footstep_Minion:
                sounds = new[]
                {
                    Sound.Footstep_Minion, Sound.Footstep_Minion_2, Sound.Footstep_Minion_3, Sound.Footstep_Minion_4,
                    Sound.Footstep_Minion_5, Sound.Footstep_Minion_6
                };
                return PlayClipAtPoint(dictionary[sounds[Random.Range(0, sounds.Length)]], pos, 140,
                    .5f * GetAudio(AudioType.Sound));
            ...
            case Sound.Player_Hit:
                sounds = new[]
                    {Sound.Player_Hit, Sound.Player_Hit_2, Sound.Player_Hit_3, Sound.Player_Hit_4, Sound.Player_Hit_5};
                return PlayClipAtPoint(dictionary[sounds[Random.Range(0, sounds.Length)]], pos, 100);
            ...
            case Sound.Minion_Sword:
                ...
                sounds = new[]
                {
                    Sound.Minion_Sword, Sound.Minion_Sword_2, Sound.Minion_Sword_3, Sound.Minion_Sword_4,
                    Sound.Minion_Sword_5, Sound.Minion_Sword_6, Sound.Minion_Sword_7, Sound.Minion_Sword_8,
                    Sound.Minion_Sword_9, Sound.Minion_Sword_10, Sound.Minion_Sword_11
                };
                return PlayClipAtPoint(dictionary[sounds[Random.Range(0, sounds.Length)]], pos);
    ...
    private static AudioSource PlayClipAtPoint(AudioClip clip, Vector3 pos, int priority, float vol, bool loop = false)
    {
        ...
        if (!loop)
        {
            ...
            globalGameObject.GetComponent<MonoBehaviourDummy>()
                .StartCoroutine(DisablePooledObject(tempGO, clip.length));
        }
        else
        {
            aSource.loop = true;
    ...
    {
        yield return globalGameObject.GetComponent<MonoBehaviourDummy>()
            .StartCoroutine(WaitForRealSeconds(time)); // waits
        if (obj != null)
        {
            obj.SetActive(false);
        }
