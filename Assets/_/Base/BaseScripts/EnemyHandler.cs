...
public class EnemyHandler : MonoBehaviour
{
    ...
    public void Damage(IEnemyTargetable attacker)
    {
        ...
        else
        {
            ...
            {
                state = State.Busy;
                unitAnimation.PlayAnimForced(hitUnitAnim, bloodDir * (Vector2.one * -1f), 1f,
                    (UnitAnim unitAnim) => { state = State.Normal; }, null, null);
            }
        }
    }
    ...
    {
        currentPathIndex = 0;
        pathVectorList = GridPathfinding.instance.GetPathRouteWithShortcuts(GetPosition(), targetPosition)
            .pathVectorList;
