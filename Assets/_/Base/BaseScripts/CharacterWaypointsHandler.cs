...
public class CharacterWaypointsHandler : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        animatedWalker = new AnimatedWalker(unitAnimation, UnitAnimType.GetUnitAnimType(idleAnimation),
            UnitAnimType.GetUnitAnimType(walkAnimation), idleFrameRate, walkFrameRate);
        state = State.Waiting;
