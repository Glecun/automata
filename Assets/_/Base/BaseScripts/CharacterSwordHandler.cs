...
public class CharacterSwordHandler : MonoBehaviour, EnemyHandler.IEnemyTargetable
{
    ...
    private void Start()
    {
        ...
        unitSkeleton = new V_UnitSkeleton(1f, bodyTransform.TransformPoint,
            (Mesh mesh) => bodyTransform.GetComponent<MeshFilter>().mesh = mesh);
    ...
    private void HandleAttack()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Space) || Input.GetMouseButtonDown(0))
        {
            ...
            */
            ...
            {
                default:
                    unitAnimation.PlayAnimForced(UnitAnimType.GetUnitAnimType("dBareHands_PunchQuick"), attackDir, 1f,
                        (UnitAnim unitAnim2) => SetStateNormal(), null, null);
                    break;
                case "dBareHands_PunchQuick":
                    unitAnimation.PlayAnimForced(UnitAnimType.GetUnitAnimType("dBareHands_KickQuick"), attackDir, 1f,
                        (UnitAnim unitAnim2) => SetStateNormal(), null, null);
                    break;
            }
