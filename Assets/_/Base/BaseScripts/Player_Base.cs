...
public class Player_Base : MonoBehaviour
{
    ...
    {
        unitAnimation.PlayAnimForced(UnitAnimType.GetUnitAnimType("dBareHands_PunchQuick"), dir, 1f,
            (UnitAnim unitAnim2) =>
            {
    ...
    {
        unitAnimation.PlayAnimForced(UnitAnimType.GetUnitAnimType("dBareHands_KickQuick"), dir, 1f,
            (UnitAnim unitAnim2) =>
            {
                if (onAnimComplete != null) onAnimComplete();
            }, (string trigger) =>
